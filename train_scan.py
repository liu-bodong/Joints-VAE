...
if __name__ == "__main__":
    # TODO: sometimes I make mistake of using different num_users or points_per_user for dataset
    # change this to load from generated file directly

    # dataset_path = "./data/joint_data_5000_4096.npy"

    # dataset_info = dataset_path.split("_")
    # NUM_USERS = int(dataset_info[2])
    # POINTS_PER_USER = int(dataset_info[3].split(".")[0])
    ...
    all_joints = np.load("./data/joint_data_5000_4096.npy")  # shape: (num_users, num_points_per_user, 4)
    ...
    for dim in LATENT_DIM:
        ...
        PATH = f"./models/point_vae_N{NUM_USERS}_K{POINTS_PER_USER}_D{dim}.pth"
